...
export type ModuleSpacerFieldsFragment = (
  { __typename?: 'ModuleSpacer', size?: string | null, theme?: string | null }
  & ComponentReferenceFields_ModuleSpacer_Fragment
);

export type ModuleSpacerQueryVariables = Types.Exact<{
...
export type ModuleSpacerQuery = { __typename?: 'Query', moduleSpacer?: (
    { __typename?: 'ModuleSpacer' }
    & ModuleSpacerFieldsFragment
  ) | null };


export const ModuleSpacerFieldsFragmentDoc = `
  ...
  theme
    ...
    `;
export const ModuleSpacerDocument = `
...
export const useModuleSpacerQuery = <
      TData = ModuleSpacerQuery,
      TError = unknown
    >(
      variables: ModuleSpacerQueryVariables,
      options?: Omit<UseQueryOptions<ModuleSpacerQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<ModuleSpacerQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<ModuleSpacerQuery, TError, TData>(
      {
    queryKey: ['ModuleSpacer', variables],
    queryFn: customFetcher<ModuleSpacerQuery, ModuleSpacerQueryVariables>(ModuleSpacerDocument, variables),
    ...options
  }
    )};

useModuleSpacerQuery.getKey = (variables: ModuleSpacerQueryVariables) => ['ModuleSpacer', variables];


useModuleSpacerQuery.fetcher = (variables: ModuleSpacerQueryVariables, options?: RequestInit['headers']) => customFetcher<ModuleSpacerQuery, ModuleSpacerQueryVariables>(ModuleSpacerDocument, variables, options);
