...
export type EventFieldsFragment = (
  { __typename?: 'Event', name?: string | null, description?: string | null, startDate?: any | null, image?: any | null, locationLabel?: string | null, location?: { __typename?: 'Location', lat?: number | null, lon?: number | null } | null, series?: (
    { __typename?: 'Series' }
...
export type NextEventForSeriesQueryVariables = Types.Exact<{
  seriesIds: Array<Types.InputMaybe<Types.Scalars['String']['input']>> | Types.InputMaybe<Types.Scalars['String']['input']>;
...
export type NextEventForSeriesQuery = { __typename?: 'Query', eventCollection?: { __typename?: 'EventCollection', items: Array<{ __typename?: 'Event', name?: string | null, description?: string | null, linkedFrom?: { __typename?: 'EventLinkingCollections', pageRaceEventCollection?: { __typename?: 'PageRaceEventCollection', items: Array<(
...
export const EventFieldsFragmentDoc = `
  ...
  series {
    ...
    `;
export const NextEventForSeriesDocument = `
...
export const useNextEventForSeriesQuery = <
      TData = NextEventForSeriesQuery,
      TError = unknown
    >(
      variables: NextEventForSeriesQueryVariables,
      options?: Omit<UseQueryOptions<NextEventForSeriesQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<NextEventForSeriesQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<NextEventForSeriesQuery, TError, TData>(
      {
    queryKey: ['NextEventForSeries', variables],
    queryFn: customFetcher<NextEventForSeriesQuery, NextEventForSeriesQueryVariables>(NextEventForSeriesDocument, variables),
    ...options
  }
    )};

useNextEventForSeriesQuery.getKey = (variables: NextEventForSeriesQueryVariables) => ['NextEventForSeries', variables];


useNextEventForSeriesQuery.fetcher = (variables: NextEventForSeriesQueryVariables, options?: RequestInit['headers']) => customFetcher<NextEventForSeriesQuery, NextEventForSeriesQueryVariables>(NextEventForSeriesDocument, variables, options);
