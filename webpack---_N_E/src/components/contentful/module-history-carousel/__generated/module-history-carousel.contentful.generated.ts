...
export type PartHistoryCarouselItemFieldsFragment = (
  { __typename?: 'PartHistoryCarouselItem', startYear?: number | null, endYear?: number | null, title?: string | null, subtitle?: string | null, description?: string | null, asset?: any | null, thumbnailAsset?: any | null, detailsAsset?: any | null }
  & ComponentReferenceFields_PartHistoryCarouselItem_Fragment
);

export type ModuleHistoryCarouselFieldsFragment = (
  { __typename?: 'ModuleHistoryCarousel', carouselItemsCollection?: { __typename?: 'ModuleHistoryCarouselCarouselItemsCollection', items: Array<(
...
export type ModuleHistoryCarouselQueryVariables = Types.Exact<{
...
export type ModuleHistoryCarouselQuery = { __typename?: 'Query', moduleHistoryCarousel?: (
    { __typename?: 'ModuleHistoryCarousel' }
    & ModuleHistoryCarouselFieldsFragment
  ) | null };


export const PartHistoryCarouselItemFieldsFragmentDoc = `
  ...
  detailsAsset
    ...
    `;
export const ModuleHistoryCarouselFieldsFragmentDoc = `
  ...
  carouselItemsCollection(limit: 10) {
    ...
    `;
export const ModuleHistoryCarouselDocument = `
...
export const useModuleHistoryCarouselQuery = <
      TData = ModuleHistoryCarouselQuery,
      TError = unknown
    >(
      variables: ModuleHistoryCarouselQueryVariables,
      options?: Omit<UseQueryOptions<ModuleHistoryCarouselQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<ModuleHistoryCarouselQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<ModuleHistoryCarouselQuery, TError, TData>(
      {
    queryKey: ['ModuleHistoryCarousel', variables],
    queryFn: customFetcher<ModuleHistoryCarouselQuery, ModuleHistoryCarouselQueryVariables>(ModuleHistoryCarouselDocument, variables),
    ...options
  }
    )};

useModuleHistoryCarouselQuery.getKey = (variables: ModuleHistoryCarouselQueryVariables) => ['ModuleHistoryCarousel', variables];


useModuleHistoryCarouselQuery.fetcher = (variables: ModuleHistoryCarouselQueryVariables, options?: RequestInit['headers']) => customFetcher<ModuleHistoryCarouselQuery, ModuleHistoryCarouselQueryVariables>(ModuleHistoryCarouselDocument, variables, options);
