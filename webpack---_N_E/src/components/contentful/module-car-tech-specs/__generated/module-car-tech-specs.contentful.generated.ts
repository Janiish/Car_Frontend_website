...
export type ModuleCarTechSpecsFieldsFragment = (
  { __typename?: 'ModuleCarTechSpecs', car?: (
    { __typename?: 'Car' }
    & CarFieldsFragment
  ) | null }
  & ComponentReferenceFields_ModuleCarTechSpecs_Fragment
...
export type ModuleCarTechSpecsQueryVariables = Types.Exact<{
...
export type ModuleCarTechSpecsQuery = { __typename?: 'Query', moduleCarTechSpecs?: (
...
export const ModuleCarTechSpecsFieldsFragmentDoc = `
  ...
  car {
    ...
    `;
export const ModuleCarTechSpecsDocument = `
...
export const useModuleCarTechSpecsQuery = <
      TData = ModuleCarTechSpecsQuery,
      TError = unknown
    >(
      variables: ModuleCarTechSpecsQueryVariables,
      options?: Omit<UseQueryOptions<ModuleCarTechSpecsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<ModuleCarTechSpecsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<ModuleCarTechSpecsQuery, TError, TData>(
      {
    queryKey: ['ModuleCarTechSpecs', variables],
    queryFn: customFetcher<ModuleCarTechSpecsQuery, ModuleCarTechSpecsQueryVariables>(ModuleCarTechSpecsDocument, variables),
    ...options
  }
    )};

useModuleCarTechSpecsQuery.getKey = (variables: ModuleCarTechSpecsQueryVariables) => ['ModuleCarTechSpecs', variables];


useModuleCarTechSpecsQuery.fetcher = (variables: ModuleCarTechSpecsQueryVariables, options?: RequestInit['headers']) => customFetcher<ModuleCarTechSpecsQuery, ModuleCarTechSpecsQueryVariables>(ModuleCarTechSpecsDocument, variables, options);
