...
export type PartnerFieldsFragment = (
  { __typename?: 'Partner', name?: string | null, logo?: any | null, url?: string | null }
  & ComponentReferenceFields_Partner_Fragment
);

export type PartnerSetFieldsFragment = (
  { __typename?: 'PartnerSet', partnersCollection?: { __typename?: 'PartnerSetPartnersCollection', items: Array<(
      { __typename?: 'Partner' }
...
export type PartnerSetQueryVariables = Types.Exact<{
...
export type PartnerSetQuery = { __typename?: 'Query', partnerSet?: (
...
export const PartnerFieldsFragmentDoc = `
  ...
  url
    ...
    `;
export const PartnerSetFieldsFragmentDoc = `
  ...
  partnersCollection(limit: 40) {
    ...
    `;
export const PartnerSetDocument = `
...
export const usePartnerSetQuery = <
      TData = PartnerSetQuery,
      TError = unknown
    >(
      variables: PartnerSetQueryVariables,
      options?: Omit<UseQueryOptions<PartnerSetQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<PartnerSetQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<PartnerSetQuery, TError, TData>(
      {
    queryKey: ['PartnerSet', variables],
    queryFn: customFetcher<PartnerSetQuery, PartnerSetQueryVariables>(PartnerSetDocument, variables),
    ...options
  }
    )};

usePartnerSetQuery.getKey = (variables: PartnerSetQueryVariables) => ['PartnerSet', variables];


usePartnerSetQuery.fetcher = (variables: PartnerSetQueryVariables, options?: RequestInit['headers']) => customFetcher<PartnerSetQuery, PartnerSetQueryVariables>(PartnerSetDocument, variables, options);
